...
export declare const updateProduct: (req: Request, res: Response) => Promise<void | Response>;
export declare const deleteProduct: (req: Request, res: Response) => Promise<void | Response>;
